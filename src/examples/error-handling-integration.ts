...
export class ACPPluginWithErrorHandling {
	...
	private updateConnectionStatus(connected: boolean, error?: string): void {
		...
		document.dispatchEvent(
			new CustomEvent('acp-connection-status', {
 ...
 * Example usage
 */
export function createACPPluginExample(
	vaultPath: string
): ACPPluginWithErrorHandling {
